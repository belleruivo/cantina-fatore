# 🧃 Gerenciamento de cantina escolar (Fatore)
...
- Documentação a ser entregue (Contém a descrição do sistema, contada através de um storytelling, a tabela de requisitos etc.):
